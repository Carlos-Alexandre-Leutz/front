      ...
      <suspense>
        <template #default>
          <Table
            ...
            pathPaginaAtual="formaPagamento"
            action="true"
  ...
  setup() {
    ...
    const onEdit = e => {
      ...
      if (e.target.dataset.edit == 1) {
        console.log("Editar");
        router.push("/formaPagamento/editar/" + e.item.id);
      }
      if (e.target.dataset.edit == 2) {
        console.log("Editar");
        router.push("/formaPagamento/editar/" + e.item.id + "/visualizar");
      }
