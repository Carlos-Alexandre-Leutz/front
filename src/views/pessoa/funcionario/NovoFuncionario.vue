  ...
  <div>
    <form @submit="validarForm">
          ...
          <div class="card shadow">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                  <div class="form-group">
                    <label>* {{ $i18n.translate("departamento") }}</label>
                    <Multiselect
                      v-model="viewModel.departamentoId"
                      :placeholder="placeholderDepartamento"
                ...
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                  <div class="form-group">
                    <label>* {{ $i18n.translate("funcao") }}</label>
                    <Multiselect
                      v-model="viewModel.funcaoId"
                      :placeholder="placeholderFuncao"
                ...
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                  <div class="form-group">
                    <label
                      >* {{ $i18n.translate("codMatriculaInterno") }}</label
                    >
                    <input
                      class="form-control"
                      type="text"
                      :placeholder="placeholderCodigoMatriculaInterno"
                      required
                      v-model="viewModel.codMatriculaInterno"
                      maxlength="10"
                      :readonly="inputReadonly"
                    />
                  </div>
                ...
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                  <div class="form-group">
                    <label>* {{ $i18n.translate("dataNascimento") }}</label>
                    <input
                      class="form-control"
                      type="date"
                      required
                      v-model="viewModel.dtNascimento"
                      maxlength="20"
                      :readonly="inputReadonly"
                    />
                  </div>
                ...
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                  <div class="form-group">
                    <label>* {{ $i18n.translate("estadoCivil") }}</label>
                    <Multiselect
                ...
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                  <div class="form-group">
                    <label>* {{ $i18n.translate("tipoContrato") }}</label>
                    <Multiselect
                      v-model="viewModel.tipoContrato"
                      :placeholder="placeholderTipoContrato"
                ...
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                  <div class="form-group">
                    <label>* {{ $i18n.translate("dataAdmissao") }}</label>
                    <input
                      class="form-control"
                      type="date"
                      required
                      v-model="viewModel.dtAdmissao"
                      :readonly="inputReadonly"
                    />
                  </div>
                </div>
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                  <div class="form-group">
                    <label>{{ $i18n.translate("dataDemicao") }}</label>
                    <input
                      class="form-control"
                      type="date"
                      v-model="viewModel.dtDemissao"
                      :readonly="inputReadonly"
                    />
                  </div>
                </div>
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                  <div class="form-group">
                    <label>* {{ $i18n.translate("tipoSalario") }}</label>
                    <Multiselect
                      v-model="viewModel.tipoSalario"
                      :placeholder="placeholderTipoSalario"
                      :options="optionsTipoSalario"
                       :disabled="inputReadonly"
                    />
                  </div>
                </div>
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                  <div class="form-group">
                    <label>* {{ $i18n.translate("Foto") }}</label>
                    <input :readonly="inputReadonly"  :disabled="inputReadonly" id="foto" class="form-control" type="file" />
                  </div>
                </div>
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                  <div class="form-group">
                    ...
                    ><br />
                    <input  :disabled="inputReadonly" type="checkbox" v-model="viewModel.snAtivo" />
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="d-flex mt-3 ml-2 buttonsActions">
        ...
        <div v-if="mostrarBtnSalvar" class="btn btn-warning ml-2" @click="limpaForm()">
          {{ $i18n.translate("limparFormulario") }}
        </div>
        <button
          class="btn btn-secondary ml-2"
          type="reset"
          @click="$router.push('/funcionario/1')"
        >
...
import servico from "../../../services/pessoa/funcionario";
...
export default {
  ...
  setup() {
    const {
      params: { funcionarioId, visualizar },
    } = useRoute();
    const getId = () => {
      return funcionarioId ? funcionarioId : store.state.emptyGuid;
    };
    ...
    let optionsDepartamento = ref([]);
    let optionsFuncao = ref([]);
    let optionsCargo = ref([]);
    let optionsGenero = ref([]);
    let optionsEstadoCivil = ref([]);
    let optionsTipoContrato = ref([]);
    let optionsTipoSalario = ref([]);
    ...
    let placeholderFuncao;
    let placeholderFuncaoReduzida;
    let placeholderCargo;
    let placeholderCodigoMatriculaInterno;
    let placeholderGenero;
    let placeholderEstadoCivil;
    let placeholderTipoContrato;
    let placeholderTipoSalario;
    ...
    onMounted(async () => {
      ...
      const PreencherSeletores = async () => {
        ...
        optionsDepartamento.value = await obterSeletor(
          "departamento/obter-seletor-departamento"
        );
        optionsTipoContrato.value = servicoEnum.pessoaFuncionarioTipoContrato;
        optionsTipoSalario.value = enumSelect.pessoaFuncionarioSalario;
        optionsFuncao.value = await obterSeletor("funcao/obter-seletor-funcao");
        optionsCargo.value = await obterSeletor("cargo/obter-seletor-cargo");
        ...
        optionsEstadoCivil.value = servicoEnum.funcionarioEstadoCivil;
      };
      PreencherSeletores();
    });
    ...
    const atualizartraducaoParametros = () => {
      ...
      placeholderDepartamento = ` ${languagePageNow.digite} ${languagePageNow.o} ${languagePageNow.departamento}`;
      placeholderFuncao = ` ${languagePageNow.selecione} ${languagePageNow.a} ${languagePageNow.funcao}`;
      placeholderFuncaoReduzida = ` ${languagePageNow.digite} ${languagePageNow.a} ${languagePageNow.funcaoReduzida}`;
      placeholderCargo = ` ${languagePageNow.selecione} ${languagePageNow.o} ${languagePageNow.cargo}`;
      placeholderCodigoMatriculaInterno = ` ${languagePageNow.digite} ${languagePageNow.o} ${languagePageNow.codigoMatriculaInterno}`;
      placeholderEstadoCivil = ` ${languagePageNow.selecione} ${languagePageNow.o} ${languagePageNow.estadoCivil}`;
      placeholderGenero = ` ${languagePageNow.selecione} ${languagePageNow.o} ${languagePageNow.genero}`;
      placeholderTipoContrato = ` ${languagePageNow.selecione} ${languagePageNow.o} ${languagePageNow.tipocontrato}`;
      placeholderTipoSalario = ` ${languagePageNow.selecione} ${languagePageNow.o} ${languagePageNow.tipoSalario}`;
    ...
    const replaceCpfCnpj = () => {
      ...
      console.log("cpf", replaceCpfCnpj);
    ...
    const salvaForm = () => {
      ...
      viewModel.value.cpfCnpj = viewModel.value.cpfCnpj.replaceAll(".", "");
      viewModel.value.cpfCnpj = viewModel.value.cpfCnpj.replaceAll("/", "");
      viewModel.value.foto = document.getElementById("foto").value;

      if (
        viewModel.value.id !== store.state.emptyGuid &&
        viewModel.value.id !== undefined
      ) {
        console.log("viewModel edicao", viewModel);
        ...
        //em memoria pq usa em outros lugares
        ...
        console.log("viewModel add", viewModel);
    ...
    const limpaForm = () => {
      ...
      viewModel.value.departamentoId = ref();
      viewModel.value.funcaoId = ref();
      viewModel.value.cargoId = ref();
      viewModel.value.codMatriculaInterno = ref("");
      viewModel.value.dtNascimento = ref();
      viewModel.value.genero = ref();
      viewModel.value.estadoCivil = ref();
      viewModel.value.tipoContrato = ref();
      viewModel.value.dtAdmissao = ref();
      viewModel.value.dtDemissao = ref();
      viewModel.value.tipoSalario = ref();
      viewModel.value.foto = ref("");
    ...
    const ObterPessoa = async id => {
      ...
      console.log(
        "retorno",
        !retorno.estadoCivil ? [] : parseInt(retorno.estadoCivil)
      );
      ...
      viewModel.value.departamentoId = retorno.departamentoId;
      viewModel.value.funcaoId = retorno.funcaoId;
      viewModel.value.cargoId = retorno.cargoId;
      viewModel.value.codMatriculaInterno = retorno.codMatriculaInterno;
      viewModel.value.dtNascimento = retorno.dtNascimento;
      viewModel.value.genero = !retorno.genero
        ? ref()
        : parseInt(retorno.genero);
      viewModel.value.estadoCivil = !retorno.estadoCivil
        ? ref()
        : parseInt(retorno.estadoCivil);
      viewModel.value.tipoContrato = !retorno.tipoContrato
        ? ref()
        : parseInt(retorno.tipoContrato);
      viewModel.value.dtAdmissao = retorno.dtAdmissao;
      viewModel.value.dtDemissao = retorno.dtDemissao;
      viewModel.value.tipoSalario = !retorno.tipoSalario
        ? ref()
        : parseInt(retorno.tipoSalario);
      viewModel.value.foto = retorno.foto;
    ...
    return {
      ...
      placeholderFuncao,
      placeholderFuncaoReduzida,
      placeholderCargo,
      placeholderCodigoMatriculaInterno,
      placeholderEstadoCivil,
      placeholderGenero,
      placeholderTipoContrato,
      placeholderTipoSalario,
