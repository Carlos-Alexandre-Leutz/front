<template>
  <div>
    <form @submit="validarForm">
          ...
          <div class="card shadow">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                  <div class="form-group">
                    <label>* {{ $i18n.translate("nomeFantasia") }}</label>
                    <input
                      :readonly="inputReadonly"
                      class="form-control"
                      type="text"
                      :placeholder="placeholderNomeFantasia"
                      required
                ...
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                  <div class="form-group">
                    ...
                    <input
                      ...
                      class="form-control"
                      type="text"
                      :placeholder="placeholderIncricaoEntadual"
                      required
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                  <div class="form-group">
                    <label> {{ $i18n.translate("responsavelTecnico") }}</label>
                    <input
                      :readonly="inputReadonly"
                      class="form-control"
                      type="text"
                      :placeholder="placeholderResponsavelTecnico"
                      v-model="viewModel.responsavelTecnico"
                      maxlength="255"
                    />
                  </div>
                </div>
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                  <div class="form-group">
                    <label> {{ $i18n.translate("autFuncionamento") }}</label>
                    <input
                      :readonly="inputReadonly"
                      class="form-control"
                      type="text"
                      :placeholder="placeholderAutorazacaoFuncionamento"
                      v-model="viewModel.autFuncionamento"
                      maxlength="10"
                    />
                  </div>
                </div>
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                  <div class="form-group">
                    <label> {{ $i18n.translate("autEspecial") }}</label>
                    <input
                      :readonly="inputReadonly"
                      class="form-control"
                      type="text"
                      :placeholder="placeholderAutorazacaoEspecial"
                      v-model="viewModel.autEspecial"
                      maxlength="10"
                    />
                  </div>
                </div>
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                  <div class="form-group">
                    <label> {{ $i18n.translate("alvaraSanitario") }}</label>
                    <input
                      :readonly="inputReadonly"
                      class="form-control"
                      type="text"
                      :placeholder="placeholderAlvaraSanitario"
                      v-model="viewModel.alvaraSanitario"
                      maxlength="10"
                    />
                  </div>
                </div>
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                  <div class="form-group">
                    <label> {{ $i18n.translate("licencaMapa") }}</label>
                    <input
                      :readonly="inputReadonly"
                      class="form-control"
                      type="text"
                      :placeholder="placeholderLicencaMapa"
                      v-model="viewModel.licencaMapa"
                      maxlength="50"
                    />
                  </div>
                </div>
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                  <div class="form-group">
                    <label> {{ $i18n.translate("hostFTP") }}</label>
                    <input
                      :readonly="inputReadonly"
                      class="form-control"
                      type="text"
                      :placeholder="placeholderHostFtp"
                      v-model="viewModel.hostFTP"
                      maxlength="70"
                    />
                  </div>
                </div>
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                  <div class="form-group">
                    <label> {{ $i18n.translate("usuarioFTP") }}</label>
                    <input
                      :readonly="inputReadonly"
                      class="form-control"
                      type="text"
                      :placeholder="placeholderUsuariosFtp"
                      v-model="viewModel.usuarioFTP"
                    />
                  </div>
                </div>
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                  <div class="form-group">
                    <label> {{ $i18n.translate("SenhaFTP") }}</label>
                    <input
                      class="form-control"
                      type="text"
                      :placeholder="placeholderSenhaFtp"
                      v-model="viewModel.senhaFTP"
                      maxlength="15"
                      :readonly="inputReadonly"
                    />
                  </div>
                ...
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                  <div class="form-group">
                    <label> {{ $i18n.translate("previsaoEntrega") }}</label>
                    <input
                      class="form-control"
                      type="number"
                      :placeholder="placeholderPrevizaoEntrega"
                ...
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                  <div class="form-group">
                    <label> {{ $i18n.translate("valorMinimoPedido") }}</label>
                    <input
                      class="form-control"
                      type="number"
                      :placeholder="placeholderValorMinimoPedido"
                      v-model="viewModel.valorMinimoPedido"
                      :readonly="inputReadonly"
                    />
                  </div>
                </div>
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                  <div class="form-group">
                    <label> {{ $i18n.translate("frete") }}</label>
                    <input
                      class="form-control"
                      type="number"
                      :placeholder="placeholderFrete"
                      v-model="viewModel.frete"
                      maxlength="100"
                      step="any"
                      :readonly="inputReadonly"
                    />
      ...
      <div class="d-flex mt-3 ml-2 buttonsActions">
        ...
        <div class="btn btn-secondary ml-2" @click="$router.push('/pessoa/1')">
...
import servico from "../../../services/pessoa/pessoa";
...
export default {
  ...
  setup() {
    ...
    let placeholderIncricaoEntadual;
    let placeholderNomeFantasia;
    let placeholderCadastroFarmacia;
    let placeholderResponsavelTecnico;
    let placeholderAutorazacaoFuncionamento;
    let placeholderAutorazacaoEspecial;
    let placeholderAlvaraSanitario;
    let placeholderLicencaMapa;
    let placeholderHostFtp;
    let placeholderUsuariosFtp;
    let placeholderSenhaFtp;
    let placeholderPrevizaoEntrega;
    let placeholderValorMinimoPedido;
    let placeholderFrete;
    let placeholderPlanoContas;
    let placeholderObservacao;
    ...
    let viewModel = ref({
      ...
      cpfCnpj: ref(),
      nomeFantasia: ref(""),
      tpFornecedor: ref(true),
      tpFuncionario: ref(false),
      tpVisitador: ref(false),
    ...
    const buscaCep = () => {
      if (!visualizar) {
        ...
        let teste2 = teste.replaceAll(".", "");
        fetch(`https://viacep.com.br/ws/${teste2}/json/`, options).then(
          response => {
    ...
    const atualizartraducaoParametros = () => {
      ...
      placeholderNomeFantasia = ` ${languagePageNow.digite} ${languagePageNow.o} ${languagePageNow.nomeFantasia}`;
      placeholderIncricaoEntadual = ` ${languagePageNow.digite} ${languagePageNow.a} ${languagePageNow.inscricaoEstadual}`;
      placeholderCadastroFarmacia = ` ${languagePageNow.digite} ${languagePageNow.o} ${languagePageNow.cadastroFarmacia}`;
      placeholderResponsavelTecnico = ` ${languagePageNow.digite} ${languagePageNow.o} ${languagePageNow.responsavelTecnico}`;
      placeholderAutorazacaoFuncionamento = ` ${languagePageNow.digite} ${languagePageNow.a} ${languagePageNow.autorizacaoFuncionamento}`;
      placeholderAutorazacaoEspecial = ` ${languagePageNow.digite} ${languagePageNow.a} ${languagePageNow.autorizacaoEspecial}`;
      placeholderAlvaraSanitario = ` ${languagePageNow.digite} ${languagePageNow.o} ${languagePageNow.alvaraSanitario}`;
      placeholderLicencaMapa = ` ${languagePageNow.digite} ${languagePageNow.a} ${languagePageNow.licencaMapa}`;
      placeholderHostFtp = ` ${languagePageNow.digite} ${languagePageNow.o} ${languagePageNow.host}`;
      placeholderUsuariosFtp = ` ${languagePageNow.digite} ${languagePageNow.a} ${languagePageNow.usuario}`;
      placeholderSenhaFtp = ` ${languagePageNow.digite} ${languagePageNow.o} ${languagePageNow.senha}`;
      placeholderPrevizaoEntrega = ` ${languagePageNow.digite} ${languagePageNow.a} ${languagePageNow.previsaoEntrega}`;
      placeholderValorMinimoPedido = ` ${languagePageNow.digite} ${languagePageNow.o} ${languagePageNow.valorMinimoPedido}`;
      placeholderFrete = ` ${languagePageNow.digite} ${languagePageNow.o} ${languagePageNow.frete}`;
      placeholderPlanoContas = ` ${languagePageNow.selecione} ${languagePageNow.o} ${languagePageNow.planoConta}`;
      placeholderObservacao = ` ${languagePageNow.digite} ${languagePageNow.a} ${languagePageNow.observacao}`;
    ...
    const salvaForm = () => {
      ...
      if (
        ...
        let vwmenderecos = viewModel.value.enderecos;
        let vwmtelefone = viewModel.value.telefones;
        let vwmcontatos = viewModel.value.contatos;
        let vwmdadosBancarios = viewModel.value.dadosBancarios;
        const zerar = index => {
          index.id = "00000000-0000-0000-0000-000000000000";
        };
        const atribuiId = index => {
          index.id = uuidv4();
        };
        vwmenderecos.forEach(zerar);
        vwmtelefone.forEach(zerar);
        vwmcontatos.forEach(zerar);
        vwmdadosBancarios.forEach(zerar);
          ...
          if (response.status == 200) {
            Swal.fire({
              ...
              if (result.isConfirmed) {
                ...
                router.push("/pessoa/1");
              }
              limpaForm();
            });
          } else {
            if (vwmenderecos) {
              vwmenderecos.forEach(atribuiId);
            }
            if (vwmtelefone) {
              vwmtelefone.forEach(atribuiId);
            }
            if (vwmcontatos) {
              vwmcontatos.forEach(atribuiId);
            }
            if (vwmdadosBancarios) {
              vwmdadosBancarios.forEach(atribuiId);
            }
            Swal.fire({
              icon: "warning",
              title: `${lengBrEs.erro}`,
    ...
    const limpaForm = () => {
      ...
      viewModel.value.nomeFantasia = ref();
      viewModel.value.inscEstadual = ref();
      viewModel.value.cadastroFarmacia = ref("");
      viewModel.value.responsavelTecnico = ref("");
      viewModel.value.autFuncionamento = ref("");
      viewModel.value.autEspecial = ref("");
      viewModel.value.alvaraSanitario = ref("");
      viewModel.value.licencaMapa = ref("");
      viewModel.value.hostFTP = ref("");
      viewModel.value.usuarioFTP = ref("");
      viewModel.value.senhaFTP = ref("");
      viewModel.value.previsaoEntrega = ref();
      viewModel.value.valorMinimoPedido = ref();
      viewModel.value.frete = ref("");
    ...
    const limparCamposDadosBancarios = () => {
    ...
    const onEditEndereco = e => {
      ...
      if (e.target.dataset.edit == 0) {
        ...
        const filtro = index => {
          if (id == index.id) {
            console.log("endereco" , typeof index.paisId)
            console.log("endereco" , index.paisId)
    ...
    const ObterPessoa = async id => {
      ...
      viewModel.value.nomeFantasia = retorno.nomeFantasia;
      viewModel.value.inscEstadual = retorno.inscEstadual;
      viewModel.value.cadastroFarmacia = retorno.cadastroFarmacia;
      viewModel.value.responsavelTecnico = retorno.responsavelTecnico;
      viewModel.value.autFuncionamento = retorno.autFuncionamento;
      viewModel.value.autEspecial = retorno.autEspecial;
      viewModel.value.alvaraSanitario = retorno.alvaraSanitario;
      viewModel.value.licencaMapa = retorno.licencaMapa;
      viewModel.value.hostFTP = retorno.hostFTP;
      viewModel.value.usuarioFTP = retorno.usuarioFTP;
      viewModel.value.senhaFTP = retorno.senhaFTP;
      viewModel.value.previsaoEntrega = retorno.previsaoEntrega;
      viewModel.value.valorMinimoPedido = retorno.valorMinimoPedido;
      viewModel.value.frete = retorno.frete;
      if (retorno.idPlanoConta != "00000000-0000-0000-0000-000000000000") {
        viewModel.value.idPlanoConta = retorno.idPlanoConta;
      } else {
        viewModel.value.idPlanoConta = "";
      }
      viewModel.value.snAtivo = retorno.snAtivo;
      viewModel.value.observacao = retorno.observacao;
      if (retorno.enderecos == null) {//id do pais estado ... esta vindo diferente
        retorno.enderecos = [];
      }
    ...
    return {
      ...
      placeholderNomeFantasia,
      placeholderIncricaoEntadual,
      placeholderCadastroFarmacia,
      placeholderResponsavelTecnico,
      placeholderAutorazacaoFuncionamento,
      placeholderAutorazacaoEspecial,
      placeholderAlvaraSanitario,
      placeholderLicencaMapa,
      placeholderHostFtp,
      placeholderUsuariosFtp,
      placeholderSenhaFtp,
      placeholderPrevizaoEntrega,
      placeholderValorMinimoPedido,
      placeholderFrete,
      placeholderPlanoContas,
      placeholderObservacao,
