<template>
  <div class="d-flex flex-column">
    <a
      ...
      href="/#/grupoProduto/novo"
      
    >
      {{ $i18n.translate("adicionar") }} {{ $i18n.translate("grupoProduto") }}
    </a>
    <div class="card shadow">
      <div class="card-header">
        {{ $i18n.translate("grupoProduto") }}
      </div>
...
export default {
  setup() {
    ...
    let pageNavegacao = getpage();
    console.log("pageNavegacao", pageNavegacao);
   ...
   const lang = () => {
    ...
    const onEdit = e => {
      ...
      if (e.target.dataset.edit == 1) {
        ...
        router.push("/grupoProduto/editar/" + e.item.id);
      }
