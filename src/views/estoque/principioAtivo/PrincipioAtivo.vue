<template>
  <div class="d-flex flex-column">
    <a
      ...
      href="/#/principioAtivo/novo"
         >
       {{ $i18n.translate("adicionar") }}  {{ $i18n.translate("principioAtivo") }}  
    </a>
  </div>
  <div class="card shadow">
    <div class="card-header">
       {{ $i18n.translate("principioAtivo") }}      
      </div>
      ...
      <suspense>
        <template #default>
          <Table
            ...
            pathPaginaAtual="principioAtivo"
            action="true"
 ...
 const lang = () => {
    ...
    const onEdit = e => {
      ...
      if (e.target.dataset.edit == 1) {
        ...
        router.push("/principioAtivo/editar/" + e.item.id);
      }
