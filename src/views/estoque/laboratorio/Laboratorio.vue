<template>
  <div class="d-flex flex-column">
    <a
      ...
      href="/#/laboratorio/novo"
   
    >
     {{ $i18n.translate("adicionar") }} {{ $i18n.translate("laboratorio") }}
    </a>
    <div class="card shadow">
      <div class="card-header">
     {{ $i18n.translate("laboratorio") }}
        ...
        <Suspense>
          <template #default>
            <Table
              ...
              :headerColumns="hColums"
              :items="items"
              :componentePaginacao="componentePaginacao"
              pathPaginaAtual="laboratorio"
              action="true"
...
import servico from "../../../services/estoque/laboratorio";
  ...
  setup() {
    ...
    const onEdit = e => {
      ...
      if (e.target.dataset.edit == 1) {
        ...
        router.push("/laboratorio/editar/" + e.item.id);
      }
    ...
    onMounted(async () => {
      ...
      const onDelete = async item => {
        try {
          ...
          console.log("Erro ao buscar laboratório!", err);
        }
      };
