          ...
          <div class="card shadow">
            <header class="card-header">
              <strong class="align-self-center">
                {{ $i18n.translate("cadastroDCI") }}</strong
              >
            </header>
            <div class="card-body">
              <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                  <div class="form-group">
                    <label>* {{ $i18n.translate("codigoDci") }}</label>
                    <input
                      v-model="viewModel.codigoDci"
                      class="form-control"
                      type="text"
                      placeholder="Digite o código Dci"
                      required
                    />
                  </div>
                </div>
...
export default {
  setup() {
    ...
    const getId = () => {
      return dciId ? dciId : store.state.emptyGuid;
    };
    let viewModel = ref({
      id: ref(getId()),
      descricao: ref(""),
    ...
    try {
      ...
      console.error("Erro ao obter dci para edição", err);
    }
    return {
      viewModel,
      getEditMode,
