<template>
  <div class="d-flex flex-column">
    ...
    >
      {{ $i18n.translate("adicionar") }}  {{ $i18n.translate("dci") }}
    </a>
  </div>
...
import servico from "../../../services/estoque/dci.js";
  ...
  setup() {
    ...
    const onEdit = e => {
      ...
      if (e.target.dataset.edit == 1) {
        ...
        router.push("/dci/editar/" + e.item.id);
      }
    ...
    onMounted(async () => {
      ...
      const onDelete = async item => {
        try {
          ...
          console.error("Erro ao buscar dcis!", err);
        }
      };
