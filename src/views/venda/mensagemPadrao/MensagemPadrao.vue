<template>
  <div class="d-flex flex-column">
    <a
      ...
      href="/#/MensagemPadrao/novo"
      title="Adicionar novo grupo de usuário"
    >
      {{ $i18n.translate("adicionar") }} {{ $i18n.translate("mensagemPadrao") }}
    </a>
        ...
        <Suspense>
          <template #default>
            <Table
              ...
              pathPaginaAtual="MensagemPadrao"
              action="true"
  ...
  setup() {
    ...
    const onEdit = e => {
      ...
      if (e.target.dataset.edit == 1) {
        ...
        router.push("/MensagemPadrao/editar/" + e.item.id);
      }
