<template>
  <div class="d-flex flex-column">
    <a
      ...
      href="/#/especialidade/novo"
      :title="especialidade"
    >
      {{ $i18n.translate("adicionar") }} {{ $i18n.translate("especialidade") }}
    </a>
...
export default {
  ...
  const langParametos = () => {
    ...
    especialidade = ` ${languagePageNow.add} ${languagePageNow.especialidade}`;
    ...
    const onEdit = e => {
      ...
      if (e.target.dataset.edit == 1) {
        ...
        router.push("/especialidade/editar/" + e.item.id);
      }
