<template>
  <div class="d-flex flex-column">
    <a
      ...
      href="/#/posAdiquirinte/novo"
      title="Adicionar novo grupo de usuário"
    >
      {{ $i18n.translate("adicionar") }} {{ $i18n.translate("posAdiquirinte") }}
    </a>
        ...
        <Suspense>
          <template #default>
            <Table
              ...
              pathPaginaAtual="posAdiquirinte"
              action="true"
...
export default {
  setup() {
    ...
    let hColumns = ref([
      ...
      {
        key: "nfeChaveRequisicao",
        label: "nfeChaveRequisicao",
      },
    ]);
    //tem que excluir essa porra aqui de todas as paginas 
    ...
    const onEdit = e => {
      ...
      if (e.target.dataset.edit == 1) {
        ...
        router.push("/posAdiquirinte/editar/" + e.item.id);
      }
