<template>
  <div class="d-flex flex-column">
    ...
    >
      {{ $i18n.translate("adicionar") }} {{ $i18n.translate("unidadeMedida") }}
    </a>
  </div>
...
export default {
  setup() {
    ...
    let hColumns = ref([
      ...
      {
        key: "fatorLactobacilos",
        label: "fatorLactobacilos",
      },
    ]);
    ...
    const onEdit = e => {
      ...
      if (e.target.dataset.edit == 1) {
        console.log("Editar");
        router.push("/unidadeMedida/editar/" + e.item.id);
      }
