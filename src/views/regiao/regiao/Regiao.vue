<template>
  <div class="d-flex flex-column">
    <a
      ...
      href="/#/regiao/novo"
    >
      {{ $i18n.translate("adicionar") }} {{ $i18n.translate("regiao") }}
    </a>
  </div>
  <div class="card shadow">
    <div class="card-header">
      {{ $i18n.translate("regiao") }}
    </div>
...
import servico from "../../../services/regiao/regiao.js";
  ...
  setup() {
    ...
    const onEdit = e => {
      ...
      if (e.target.dataset.edit == 1) {
        ...
        router.push("/regiao/editar/" + e.item.id);
      }
